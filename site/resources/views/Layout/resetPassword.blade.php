        ...
        <div class="form-holder">
            <div class="form-content">
                <div class="form-items">
                    ...
                    <form action="{{route('Layout.updatePassword')}}" method="post">
                        @csrf
...
<input type="hidden" name="id" value="{{ $forgetPassword->id }}">
                        <input class="form-control" type="password" name="password" placeholder="Password" value="{{old('password')}}"  >
                        <span class="text-danger">@error ('password'){{ $message }} @enderror</span>

                            <input class="form-control" type="password" placeholder="Confirm Password" value="{{old('password')}}"  >
                        <span class="text-danger">@error ('password'){{ $message }} @enderror</span>

                        <div class="form-button">
                            <button id="submit" type="submit" class="ibtn">Reset</button>
                        </div>
                    </form>
