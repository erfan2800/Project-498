        ...
        <div class="row">
            ...
            <aside class="col col-xl-3 order-xl-1 col-lg-12 order-lg-1 col-12">
                <div class="box mb-3 shadow-sm border rounded bg-white profile-box text-center">
                    <div class="py-4 px-3 border-bottom">
                        <img src="{{asset('images/p13.png')}}" class="img-fluid mt-2 rounded-circle" alt="Responsive image">
                        <h5 class="font-weight-bold text-dark mb-1 mt-4">Gurdeep usdm</h5>
                ...
                <div class="box shadow-sm border rounded bg-white mb-3">
                    ...
                    <div class="box-body">
                        <div class="d-flex align-items-center usdm-post-header p-3 border-bottom people-list">
                            <div class="dropdown-list-image mr-3">
                                <img class="rounded-circle" src="{{asset('images/l4.png')}}" alt="">
                            </div>
                        ...
                        <div class="d-flex align-items-center usdm-post-header p-3 border-bottom people-list">
                            <div class="dropdown-list-image mr-3">
                                <img class="rounded-circle" src="{{asset('images/l8.png')}}" alt="">
                            </div>
                            <div class="font-weight-bold">
                        ...
                        <div class="d-flex align-items-center usdm-post-header p-3 people-list">
                            <div class="dropdown-list-image mr-3">
                                <img class="rounded-circle" src="{{asset('images/l5.png')}}" alt="">
                            </div>
                            <div class="font-weight-bold">
                ...
                <div class="box shadow-sm mb-3 rounded bg-white ads-box text-center overflow-hidden">
                    <img src="{{asset('images/job1.png')}}" class="img-fluid" alt="Responsive image">
                    <div class="p-3 border-bottom">
                        <h6 class="font-weight-bold text-dark">usdm Solutions</h6>
                ...
                <div class="box shadow-sm border rounded bg-white mb-3">
                    ...
                    <div class="box-body p-3 border-bottom">
                        <div class="d-flex align-items-top job-item-header pb-2">
                            ...
                            <img class="img-fluid ml-auto mb-auto" src="{{asset('images/l3.png')}}" alt="">
                        </div>
                    ...
                    <div class="box-body p-3 border-bottom">
                        <div class="d-flex align-items-top job-item-header pb-2">
                            ...
                            <img class="img-fluid ml-auto mb-auto" src="{{asset('images/l6.png')}}" alt="">
                        </div>
                    ...
                    <div class="box-body p-3">
                        <div class="d-flex align-items-top job-item-header pb-2">
                            ...
                            <img class="img-fluid ml-auto mb-auto" src="{{asset('images/l2.png')}}" alt="">
                        </div>
                ...
                <div class="box shadow-sm border rounded bg-white mb-3">
                    ...
                    <div class="box-body p-3 border-bottom">
                        <div class="d-flex align-items-top job-item-header pb-2">
                            ...
                            <img class="img-fluid ml-auto mb-auto" src="{{asset('images/e1.png')}}" alt="">
                        </div>
                        <p class="mb-0">Find the most qualified people in the most unexpected places. Information for applicants to consider when applying for local positions.</p>
                    </div>
                    <div class="box-body p-3">
                        <div class="d-flex align-items-top job-item-header pb-2">
                            ...
                            <img class="img-fluid ml-auto mb-auto" src="{{asset('images/e2.png')}}" alt="">
                        </div>
            ...
            <aside class="col col-xl-3 order-xl-3 col-lg-12 order-lg-3 col-12">
                <div class="box shadow-sm border rounded bg-white mb-3">
                    ...
                    <div class="box-body p-3">
                        <div class="d-flex align-items-center usdm-post-header mb-3 people-list">
                            <div class="dropdown-list-image mr-3">
                                <img class="rounded-circle" src="{{asset('images/p4.png')}}" alt="">
                        ...
                        <div class="d-flex align-items-center usdm-post-header mb-3 people-list">
                            <div class="dropdown-list-image mr-3">
                                <img class="rounded-circle" src="{{asset('images/p9.png')}}" alt="">
                                <div class="status-indicator bg-success"></div>
                            </div>
                            <div class="font-weight-bold mr-2">
                        ...
                        <div class="d-flex align-items-center usdm-post-header mb-3 people-list">
                            <div class="dropdown-list-image mr-3">
                                <img class="rounded-circle" src="{{asset('images/p10.png')}}" alt="">
                                <div class="status-indicator bg-success"></div>
                            </div>
                            <div class="font-weight-bold mr-2">
                        ...
                        <div class="d-flex align-items-center usdm-post-header mb-3 people-list">
                            <div class="dropdown-list-image mr-3">
                                <img class="rounded-circle" src="{{asset('images/p11.png')}}" alt="">
                                <div class="status-indicator bg-success"></div>
                            </div>
                            <div class="font-weight-bold mr-2">
                        ...
                        <div class="d-flex align-items-center usdm-post-header people-list">
                            <div class="dropdown-list-image mr-3">
                                <img class="rounded-circle" src="{{asset('images/p12.png')}}" alt="">
                                <div class="status-indicator bg-success"></div>
                            </div>
                            <div class="font-weight-bold mr-2">
                ...
                <div class="box shadow-sm mb-3 rounded bg-white ads-box text-center overflow-hidden">
                    <img src="{{asset('images/ads1.png')}}" class="img-fluid" alt="Responsive image">
                    <div class="p-3 border-bottom">
                        <h6 class="font-weight-bold text-gold">usdmin Premium</h6>
                ...
                <a href="job-profile.html">
                    <div class="shadow-sm border rounded bg-white job-item mb-3">
                        <div class="d-flex align-items-center p-3 job-item-header">
                            ...
                            <img class="img-fluid ml-auto" src="{{asset('images/l3.png')}}" alt="">
                        </div>
                ...
                <a href="job-profile.html">
                    <div class="shadow-sm border rounded bg-white job-item mb-3">
                        <div class="d-flex align-items-center p-3 job-item-header">
                            ...
                            <img class="img-fluid ml-auto" src="{{asset('images/l4.png')}}" alt="">
                        </div>
                        <div class="d-flex align-items-center p-3 border-top border-bottom job-item-body">
                            <div class="overlap-rounded-circle">
